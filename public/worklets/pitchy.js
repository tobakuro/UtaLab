...
// node_modules/.pnpm/fft.js@4.0.4/node_modules/fft.js/lib/fft.js
var require_fft = __commonJS({
  'node_modules/.pnpm/fft.js@4.0.4/node_modules/fft.js/lib/fft.js'(exports, module) {
    'use strict';
    function FFT2(size) {
      this.size = size | 0;
...
// node_modules/.pnpm/pitchy@4.1.0/node_modules/pitchy/index.js
...
var Autocorrelator = class _Autocorrelator {
  ...
  static forFloat32Array(inputLength) {
    return new _Autocorrelator(inputLength, (length) => new Float32Array(length));
  }
  /**
   * A helper method to create an {@link Autocorrelator} using
  ...
  static forFloat64Array(inputLength) {
    return new _Autocorrelator(inputLength, (length) => new Float64Array(length));
  }
  /**
